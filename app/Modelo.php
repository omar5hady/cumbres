...
class Modelo extends Model
{
    ...
    protected $fillable = ['nombre','tipo','fraccionamiento_id','terreno', 'recorrido',
                                'construccion','archivo','espec_obra'];//asignacion en masa, definir las columnas de la tabla a la que se les mandaran valores

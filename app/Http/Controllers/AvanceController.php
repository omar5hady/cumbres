...
class AvanceController extends Controller
{
    ...
    */
    ...
    public function indexProm(Request $request){
        ...
        'lotes.etapa_servicios','lotes.fecha_ini','lotes.fecha_fin', 'lotes.fin_obra','lotes.paquete', 'lotes.contrato');
    ...
    public function update(Request $request)
    {
        ...
        */
        ...
        /* Checking if the progress is greater than 95% and if the date of birth is null. If both are
        true, then it sets the date of birth to the current date. */
        if($licencia->avance >= 95 && $licencia->date_birth == NULL)
            $licencia->date_birth = Carbon::now();

...
class lote extends Model
{
    ...
    protected $fillable = ['fraccionamiento_id','etapa_id','manzana','num_lote','sublote','modelo_id',
                            ...
                            'aviso','obra_extra', 'habilitado','apartado','contrato','excedente_terreno','precio_base'];//asignacion en masa, definir las columnas de la tabla a la que se les mandaran valores

...
class Contrato extends Model
{
    ...
    protected $fillable = [
        ...
        'escrituras','credito_neto','status','avaluo_cliente','fecha','monto_total_credito','total_pagar',
        'direccion_empresa','cp_empresa','colonia_empresa','estado_empresa','ciudad_empresa',

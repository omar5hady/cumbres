...
class Fraccionamiento extends Model
{
    ...
    protected $fillable = ['nombre','tipo_proyecto','calle','colonia','estado','ciudad','archivo_planos','archivo_escrituras'];//asignacion en masa, definir las columnas de la tabla a la que se les mandaran valores

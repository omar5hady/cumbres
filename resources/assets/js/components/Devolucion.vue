<template >
    <main class="main" >
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row" v-if="listado == 2">
                            <div class="col-md-8">
                                <div class="input-group">
                                    ...
                                    <a  :href="'/devoluciones/excel?buscar=' + buscar + '&b_etapa_d=' + b_etapa + '&b_manzana_d=' +b_manzana +
                                            '&b_lote=' + b_lote +'&criterio_d=' + criterio +'&b_empresa='+ b_empresa"
                                        class="btn btn-success"><i class="fa fa-file-text"></i> Excel
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="container" v-if="arrayContratos">
                                <TableComponent
                                    :cabecera="[
                                        ...
                                        'Etapa','Manzana','Lote','Depositos',
                                        'Pendiente Devolver','Fecha cancelación',
                                        'Observaciones',
                                    ]"
                                >
                                            ...
                                            <template v-if="contrato.devolver > 0">
                                                ...
                                                <td class="td2">
                                                    ...
                                                    <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 39px, 0px);">
                                                        <a title="Click para crear devolución" class="dropdown-item" @click="abrirPDF(contrato.id)">Estado de cuenta</a>
                                                    </div>
                                                </td>
                                                <td class="td2">
                                                ...
                                                <td class="td2" v-text="'$'+$root.formatNumber(contrato.sumaPagares - contrato.sumaRestante)"></td>
                                                <td class="td2" v-text="'$'+$root.formatNumber(contrato.devolver)"></td>
                        ...
                        <template v-if="listado == 2">
                            <div class="container" v-if="arrayDevoluciones">
                                ...
                                >
                                    <template v-slot:tbody>
                                        <tr v-for="(devoluciones, index) in arrayDevoluciones.data" :key="index" @dblclick="abrirModal('info',devoluciones)" title="Doble click">
            ...
            <!--Inicio del modal -->
            <ModalDevolucionCancelacion v-if="modal == 1"
                :titulo="tituloModal"
                :data="datos"
    ...
    export default {
        ...
        methods : {
            ...
            listarContratos(page){
                let me = this;
                me.loading = true;
                const url = '/devolucion/index?page=' + page + '&buscar=' + me.buscar + '&b_etapa=' + me.b_etapa + '&b_manzana=' + me.b_manzana +
                '&b_lote=' + me.b_lote +  '&criterio=' + me.criterio+'&b_empresa='+me.b_empresa+'&b_status='+me.b_status;
            ...
            listarDevoluciones(page){
                let me = this;
                me.loading = true;
                var url = '/devolucion/indexDevoluciones?page=' + page + '&buscar=' + me.buscar + '&b_etapa=' + me.b_etapa +
            ...
            abrirModal(accion,data =[]){
                switch(accion){
                    case 'devolucion':
                    {
                        ...
                        this.datos.depositos = data['sumaPagares'] - data['sumaRestante'];

            ...
            <div class="container-fluid">
                ...
                <div class="card scroll-box">
                    <div class="card-header">
                        <i class="fa fa-align-justify"></i> Resumen Créditos Puente
                        <button v-if="vista == 1" @click="listarCreditos(1)" class="btn btn-secondary">
                            ...
                            <div class="form-group row">
                                <div class="col-md-8">
                                    <div class="input-group">
                                        <select class="form-control" @keyup.enter="listarCreditos(1)" v-model="buscar" >
                                            <option value="">Seleccione</option>
                                            <option v-for="proyecto in arrayProyectos" :key="proyecto.id" :value="proyecto.id" v-text="proyecto.nombre"></option>
                                        </select>
                                        <input type="text" class="form-control" v-model="b_folio" @keyup.enter="listarCreditos(1)" placeholder="Folio">
                                    </div>
                                    <div class="input-group">
                                        <button type="submit" @click="listarCreditos(1)" class="btn btn-primary"><i class="fa fa-search"></i> Buscar</button>
                                    </div>
                                </div>
                            </div>
                                ...
                                <table class="table2 table-bordered table-striped table-sm">
                                    ...
                                    <tbody>
                                        <tr v-for="creditosPuente in arrayCreditosPuente" :key="creditosPuente.id" @click="getLotesPuente(creditosPuente)">
                                            ...
                                            <td class="td2" v-text="creditosPuente.lotes"></td>
                                            <td class="td2"> ${{formatNumber(creditosPuente.credito_otorgado)}}</td>
                                            <td class="td2"> ${{formatNumber(creditosPuente.cargo)}}</td>
                                            <td class="td2"> ${{formatNumber(creditosPuente.abono)}}</td>
                                            <td class="td2"> ${{formatNumber(creditosPuente.totalInteres)}}</td>
                                            <td class="td2">
    ...
    export default {
        ...
        methods : {
            ...
            listarCreditos(page){
                let me = this;
                me.vista = 0;
                var url = '/cPuentes/resumenCreditos?page=' + page + '&fraccionamiento=' + me.buscar + '&folio=' + me.b_folio + '&status=' + me.b_status;

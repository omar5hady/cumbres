        ...
        <div class="container-fluid">
            ...
            <div class="card scroll-box">
                <div class="card-header">
                    <i class="fa fa-align-justify"></i> Fondo de pensión
                    <div class="button-header">
                        <button v-if="(adminMant == 'shady' || adminMant == 'marce.gaytan') && busqueda.user_id && busqueda.nombre != ''"
...
export default {
    ...
    methods: {
        ...
        nuevoMovimiento(){
            this.modal.mostrar = 1;
            this.modal.titulo = `Nuevo movimiento para: ${this.busqueda.nombre}`
        ...
        update(){
            ...
            axios.put(`/fondo-pension/${me.datosPago.id}`,{
        ...
        deletePago(pago){
            swal({
                ...
                if (result.value) {
                    let me = this;
                axios.delete(`/fondo-pension/${pago.id}`, {

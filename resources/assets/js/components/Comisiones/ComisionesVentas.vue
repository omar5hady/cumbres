                ...
                <div class="modal-dialog modal-primary modal-lg" role="document">
                    <div class="modal-content">
                      ...
                      <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                        ...
                                        <table class="table table-bordered table-striped table-sm">
                                            ...
                                            <tbody>
                                                <tr v-for="venta in arrayVentas" :key="venta.id">
                                                    ...
                                                    <td v-text="venta.tipo_credito + '(' + venta.institucion + ')'"></td>
                                                    ...
                                                    <!----------------------->
                                                    <td v-text="'$'+formatNumber(venta.comision_pagar = (venta.precio_venta * (venta.porcentaje_comision_pagar/100)))"></td>
                                                    ...
                                                    <!------->
                                                        <td v-if="venta.indiv == 0" v-text="'$'+formatNumber(venta.por_pagar = (venta.comision_pagar / 2))"></td>
                            ...
                            <!-- Individualizadas -->
                                <div class="form-group row">
                                    <h6 v-if="ventas==1 && numIndividualizadas != 0"  style="font-weight: bold; color: blue;" class="col-md-3">Individualizadas: {{this.numIndivi}}</h6>
                                </div>

                                <div class="form-group row" v-if="ventas==1 && numIndividualizadas != 0">
                                    <div class="col-md-12">
                                        <table class="table table-bordered table-striped table-sm">
                                            <thead>
                                                <tr>
                            ...
                            <!-- CANCELACIONES -->
                                <div class="form-group row">
                                    <h6 v-if="ventas==1 & numCancelaciones != 0"  style="font-weight: bold; color: blue;" class="col-md-3">Cancelaciones: {{this.numAnticipos}}</h6>
                                </div>

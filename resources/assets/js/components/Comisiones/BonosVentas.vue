<template>
    <main class="main">
                ...
                <template v-else>
                    ...
                    <div class="card-body" v-if="historial == 0">
                        ...
                        <TableComponent :cabecera="[
                            'Folio','Proyecto','Etapa','Manzana','# Lote','Cliente',
                            'Asesor','Bono',''
                        ]">
                    ...
                    <div class="card-body" v-if="historial == 1">
                        ...
                        <TableComponent :cabecera="[
                            ' ','Folio','Proyecto','Etapa','Manzana','# Lote','Asesor',
                            'Fecha de bono','Bono','Descripcion','Duplicar',''
                        ]">
                            <template v-slot:tbody>
            ...
            <ModalComponent v-if="modal2" :titulo="tituloModal"
                @closeModal="cerrarModal()"
            >
                <template v-slot:body>
                    <div class="form-group row">

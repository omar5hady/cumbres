    ...
    <div class="form-group row">
        <div class="col-md-6">
            <div class="input-group">
                <select class="form-control" v-model="serch.b_empresa" >
    ...
    <div class="form-group row">
        <div class="col-md-10">
            <div class="input-group">
                ...
                <select class="form-control col-md-5" v-model="serch.criterio">
                ...
                <select class="form-control" v-if="criterio=='lotes.fraccionamiento_id'"
                    v-model="serch.buscar" @change="$root.selectEtapa(buscar), search.b_etapa = ''">
                    <option value="">Seleccione</option>
                    <option v-for="proyecto in $root.$data.proyectos" :key="proyecto.id" :value="proyecto.id"
                        v-text="proyecto.nombre">
                    </option>
                </select>
                <select class="form-control" v-else-if="criterio=='expedientes.gestor_id'" v-model="serch.buscar">
                    <option value="">Gestor</option>
                    <option v-for="gestor in $root.$data.arrayGestores" :key="gestor.id" :value="gestor.id"
                        v-text="gestor.nombre_gestor">
                    </option>
                </select>
                <input v-else type="text"  v-model="buscar" @keyup.enter="$emit('listarData', search)" class="form-control" placeholder="Texto a buscar">
            </div>
            <div class="input-group">
                <select class="form-control col-md-6" v-if="criterio=='lotes.fraccionamiento_id'" v-model="serch.b_etapa">
            ...
            <div class="input-group">
                <input type="text" v-if="criterio=='lotes.fraccionamiento_id'" v-model="serch.b_manzana" class="form-control" placeholder="Manzana a buscar">
                <input type="text" v-if="criterio=='lotes.fraccionamiento_id'" v-model="serch.b_lote" class="form-control" placeholder="Lote a buscar">
            </div>
        </div>
    </div>
    <div class="form-group row">
        <div class="col-md-10">
            ...
            <div class="input-group">
                ...
                <a :href="'/expediente/excelAutorizados?buscar=' + serch.buscar + '&b_etapa=' + serch.b_etapa + '&b_manzana=' + serch.b_manzana + '&b_lote=' +
                    serch.b_lote +  '&criterio=' + serch.criterio+'&b_empresa='+serch.b_empresa"
    ...
    >
        <template v-slot:tbody>
            <tr v-for="item in arrayData" :key="item.id"
                ...
                <td class="td2" v-if="item.email_institucional == null">
                ...
                <td class="td2" v-else>
                    <a title="Enviar correo" class="btn btn-secondary"
                        :href="'mailto:'+item.email+ ';'+item.email_institucional">
                        <i class="fa fa-envelope-o fa-lg"></i>
                    </a>
                </td>
                ...
                <td class="td2" v-if="band==1">
                    ...
                    @change="actualizarVigencia(item.folio,$event.target.value)" :id="item.folio"

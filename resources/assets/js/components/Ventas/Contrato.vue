                                    ...
                                    <div class="form-group row border border-primary" style="margin-right:0px; margin-left:0px;">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <label for="">Estado <span style="color:red;" v-show="estado==''">(*)</span></label>
                                                    <select class="form-control" v-if="listado==3 || listado==4 && btn_actualizar==1" v-model="estado" @click="selectCiudades(estado,0)" >
                                                        <option value="">Seleccione</option>
                                        ...
                                        <div class="form-group row border border-dark" style="margin-right:0px; margin-left:0px;" v-if="coacreditado==true" >  
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <label for="">Estado <span style="color:red;" v-show="estado_coa==''">(*)</span></label>
                                                        <select v-if="listado==3 || listado==4 && btn_actualizar==1" class="form-control" v-model="estado_coa" @click="selectCiudades(estado_coa,1)" >
                                                            <option value="">Seleccione</option>
                                            ...
                                            <div class="col-md-12">
                                                <template v-if="modelo != 'Terreno'">
                                                    <div style="text-align: right;" v-if="rolId!=2">
                                                        ...
                                                        <a class="btn btn-warning btn-sm" v-if="listado==4 && tipo_credito=='Crédito Directo' && btn_actualizar==0 || listado==4 && tipo_credito=='Apartado' && btn_actualizar==0" target="_blank" v-bind:href="'/contratoCompraVenta/reservaDeDominio/pdf/'+id">Imprimir contrato</a>

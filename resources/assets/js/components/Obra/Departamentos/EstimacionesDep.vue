<template>
    <main class="main">
                ...
                <div class="card scroll-box">
                    ...
                    <template v-else>
                        ...
                        <template v-if="listado == 1">
                            <div class="card-body">
                                ...
                                <TableComponent :cabecera="[
                                    '','Clave','Contratista',
                                    'Fraccionamiento','Importe del contrato','Fondo de Garantía a Retener'
                                ]">
                        ...
                        <div class="card-body">
                                ...
                                <!-- TABLA RESUMEN -->
                                <TableComponent v-if="nueva == 0 && editarEstimacion == 0"
                                    :cabecera="[
                                        '','Acum Ant','Esta Estimación','Acum Actual','Por Estimar'
                                    ]"
                                >
                                    <template v-slot:tbody>
                                        <tr>
            ...
            <ModalComponent v-if="modal" :size="'modal-md'"
                :titulo="tituloModal"
            ...
            >
                ...
                <template v-slot:buttons-footer>
                    <button v-if="observacion != ''"
                        type="button" class="btn btn-primary" @click="storeObs()">Guardar
                    </button>
                </template>
            </ModalComponent>
            <!--Fin del modal-->

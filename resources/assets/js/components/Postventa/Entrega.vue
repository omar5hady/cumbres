                                        ...
                                        <template>
                                            ...
                                            <td> 
                                                <button title="Ver todas las observaciones" type="button" class="btn btn-info pull-right" 
                                                    @click="abrirModal('observaciones', contratos),listarObservacion(1,contratos.id)">Ver observaciones
                                                </button> 
                                            </td>
                                        </template>
                                    </tr>
    ...
    export default {
        ...
        methods : {
            ...
            storeObservacion(){
                ...
                axios.post('/entregas/registrarObservacion',{
            ...
            listarObservacion(page, buscar){
                let me = this;
                var url = '/entregas/indexObservacion?page=' + page + '&buscar=' + buscar ;
                axios.get(url).then(function (response) {
                    var respuesta = response.data;

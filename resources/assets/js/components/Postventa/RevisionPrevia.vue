                        ...
                        <div class="form-group row">
                            <div class="col-md-10">
                                <div class="input-group">
                                    ...
                                    <template v-else-if="criterio2 == 'entregas.fecha_program'" >
                                         <input  type="date"  v-model="buscar2" @keyup.enter="listarContratos(1,buscar2,b_etapa2,b_manzana2,b_lote2,criterio2)" class="form-control" placeholder="Texto a buscar">
                                        <input  type="date"  v-model="b_etapa2" @keyup.enter="listarContratos(1,buscar2,b_etapa2,b_manzana2,b_lote2,criterio2)" class="form-control" placeholder="Texto a buscar">
                                    </template>
                                ...
                                <div class="input-group" v-if="criterio2=='lotes.fraccionamiento_id'">
                                    <select class="form-control" @click="selectLotesManzana(buscar2,b_etapa2,b_manzana2)" @keyup.enter="listarContratos(1,buscar2,b_etapa2,b_manzana2,b_lote2,criterio2)" v-model="b_manzana2" >

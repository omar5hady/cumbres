...
<head>
  ...
  <body class="app flex-row align-items-center">
    <figure onclick="window.location='/'" >
	<div class="sad-mac"></div>
	<figcaption>
		<span onclick="window.location='/'" class="sr-text">Error 404: Not Found</span>
		<span onclick="window.location='/'" class="e"></span>
		<span onclick="window.location='/'" class="r"></span>
		<span onclick="window.location='/'" class="r"></span>
		<span onclick="window.location='/'" class="o"></span>
		<span onclick="window.location='/'" class="r"></span>
		<span onclick="window.location='/'" class="_4"></span>
		<span onclick="window.location='/'" class="_0"></span>
		<span onclick="window.location='/'" class="_4"></span>
		<span onclick="window.location='/'" class="n"></span>
		<span onclick="window.location='/'" class="o"></span>
		<span onclick="window.location='/'" class="t"></span>
		<span onclick="window.location='/'" class="f"></span>
		<span onclick="window.location='/'" class="o"></span>
		<span onclick="window.location='/'" class="u"></span>
		<span onclick="window.location='/'" class="n"></span>
		<span onclick="window.location='/'" class="d"></span>
	</figcaption>
</figure>
  </body>
</html>

...
<div style="margin-top: 250px; position: absolute; width: 100%; left:80px; right:80px;">
   ...
   se responsabiliza en dejar los ductos necesarios para que a futuro la empresa(s) {{$archivos[0]->empresas_telecom}}, realice el cableado para llevar los servicios antes mencionados a su nueva casa.
   </p>
   ...
   <p align="justify">La fecha en la que podrá disponer con tales servicios,<strong> NO depende de Grupo Constructor Cumbres, S.A de C.V.</strong>
    Es decir, la empresa(s) {{$archivos[0]->empresas_telecom}} definirá en que fecha podrá otorgar estos servicios.</p>

    <p align="justify">Una vez entregada su casa, usted podrá contratar los servicios con empresas que los proporcionen de manera satelital tales como: {{$archivos[0]->empresas_telecom_satelital}} entre otros o bien el de su conveniencia.

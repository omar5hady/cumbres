            ...
            @endif
                ...
                <div class="table-row">
                    @if($contratos[0]->emp_constructora == 'CONCRETANIA' && $contratos[0]->emp_terreno == 'CONCRETANIA')
                        <div colspan="12" class="table-cell" style="text-align:center;"><hr style="border-color:gray;">  www.concretania.mx</div>
                    @else
                        <div colspan="12" class="table-cell" style="text-align:center;"><hr style="border-color:gray;">  www.casascumbres.mx</div>
                    @endif
                </div>
        </div>
</div>
...
@endif
  ...
  <br>
    ...
    <br>
    <div class="container">
        <center><h4><strong>IMPORTANTE: En todos los depósitos  o transferencias favor de anotar la referencia:
        <u> {{$contratos[0]->id}} </u> para poder identificar su pago.</strong></h4></center>
    </div>

 <br>

 <u><H5>INDICACIONES: </H5></u>

...
<body>
    <div>
        ...
        <p><strong>SI.- Declaran “LOS PROMITENTENTES VENDEDORES”:</strong></p>
        ...
        <ol class="ul-custom">
            ...
            <li>
                Que las facultades de su representante legal constan en la escritura pública número3 de fecha 8 de diciembre del
                1999, otorgada ante el Notario Público número 33 del primer distrito judicial de San Luis
                Potosí, Lic. Leopoldo de la Garza Marroquín, inscritaen el Registro Público de la Propiedad y del
                Comercio en San Luis Potosí, bajo el folio mercantil 70, mismas atribuciones que no le han sido
            ...
            <li>
                ...
                <strong>“Anexo A”,</strong> que firmado por las partes, es integrante de este instrumento y se localiza en la
                siguiente ubicación;
                <p>
        ...
        <ol>
            ...
            <li>
                Que  las facultades de su representante constan en la escritura pública número 764 de fecha 25 de julio del 2018,
        ...
        <ol>
            <li>
                Que es su voluntad celebrar el presente contrato por virtud del cual se establecen los términos y condiciones
            ...
            <li>
                ...
                dicho inmueble debe estar libre de todo gravamen que afecte la propiedad de <strong>“EL PROMITENTE COMPRADOR”</strong>
                sobre el mismo.
            </li>
        ...
        <p>
            Habiendo declarado lo anterior, las partes se obligan en los términos de las siguientes
            <br>
        </p>
        ...
        <p>
            ...
            suspensiva referida en la Cláusula Segunda siguiente.
            {{-- Corresponde a “CUMBRES” la celebración del contrato de
        ...
        <p>
            ...
            {{$contrato->diasTramites}} días hábiles posteriores a la fecha en que la institución o en su caso instituciones
            acreditantes hayan notificado ya sea a <strong>"EL PROMITENTE COMPRADOR"</strong> o a <strong>"LOS PROMITENTES VENDEDORES"</strong>,
            según sea el caso, que le fue aprobado y otorgado el crédito a <strong>"EL PROMITENTE COMPRADOR"</strong>. Las partes
            podrán convenir las prórrogas que estimen convenientes para la firma del contrato definitivo de compraventa respectivo.
            {{-- en que se haya liquidado el importe total de la operación.
            Las partes podrán convenir las prórrogas que estimen convenientes para la firma de escritura pública. --}}

        </p>

        <p>
            La firma de la escritura pública se llevará a cabo ante el Notario Público que designen las partes, debiendo respetar
            el derecho de <strong>“EL PROMITENTE COMPRADOR”</strong> de poder elegir a dicho notario público
            <strong>
        ...
        <p>
            <strong>
                CUARTA.- <u>PRECIO EN EL CONTRATO DE COMPRAVENTA.</u>
                “LOS PROMITENTES VENDEDORES”
            </strong>
            no podrán
            <strong>incrementar injustificadamente el precio por fenómenos naturales, meteorológicos, o contingencias sanitarias.
                En caso de que el importe del crédito no sea sificiente para pagar el precio total, "EL PROMITENTE COMPRADOR" pagara
                la diferencia a "EL PROMITENTE VENDEDOR" al momento de la firma de la escritura pública respectiva.
            </strong>
        </p>
        ...
        <p>
            <ul class="ul-custom">
                <li class="li-custom">
                    El objeto de la compraventa será el inmueble integrado por el terreno y edificaciones descritas en el “Anexo A”.
                </li>
                <li class="li-custom">
                ...
                <li class="li-custom">
                    La transmisión de la propiedad del inmueble a favor de <strong>“EL PROMITENTE COMPRADOR”</strong>
                ...
                <li class="li-custom">
                    ...
                    se obligaráN al saneamiento para el caso de evicción y <strong>“CONCRETANIA”</strong> a responder
                ...
                <li class="li-custom">
                    <strong>
                        LOS PROMITENTES VENDEDORES</strong> otorgaráN a <strong>“EL PROMITENTE COMPRADOR”</strong> las garantías que en términos del artículo
        ...
        <p>
            <strong>
                ...
                “LOS PROMITENTES VENDEDORES”</strong>
            </strong>
            notificarán a <strong>“EL PROMITENTE COMPRADOR”</strong> ya sea al número telefónico, correo electrónico o
            en el domicilio indicados en la Cláusula Novena, con al menos con 3 (tres) días hábiles de anticipación, la fecha para
            recibir la posesión material del inmueble. <strong>En caso de que “EL PROMITENTE COMPRADOR”
            no concurra en la fecha fijada para recibir la posesión</strong> del inmueble <strong>“EL PROMITENTE VENDEDOR”</strong>
            le concederá hasta 30 días naturales más para su recepción y en caso de nueva inasistencia se levantará acta circunstanciada
            ante dos testigos que haga constar tal situación, y se entenderá que
        ...
        <p>
            ...
            le informarán a <strong>“EL PROMITENTE COMPRADOR”  mediante el medio de comunicación por este determinado,
            </strong> el día y hora programado para llevar a cabo la inspección física en las áreas específicas de la
        ...
        <p>
            ...
            <strong>“LOS PROMITENTES VENDEDORES”
        ...
        <p>
            ...
            <strong> “LOS PROMITENTES VENDEDORES”</strong> cedan o transmitan</strong>
            a terceros, con fines mercadotécnicos o publicitarios, la información proporcionada por él con motivo del presente Contrato y si (  ) no (  ) acepta que
            <strong> “LOS PROMITENTES VENDEDORES”</strong> le envíen publicidad sobre bienes y servicios.
        </p>
        ...
        <p>
            <strong>NOVENA.- <u>PROCESO DE CANCELACIÓN.</u> “EL PROMITENTE COMPRADOR”</strong> podrá cancelar el presente contrato,
            sin responsabilidad alguna, siempre y cuando esté dentro de los 5 días hábiles siguientes a su firma,
            sin menoscabo de los pagos realizados, así como la obligación del
            <strong>
                “LOS PROMITENTES VENDEDORES”
        ...
        <p>
            <ul class="ul-custom">
                ...
                <li class="li-custom">
                    ...
                    <ol>
                        <li>
                            Realizar el pago de los gastos operativos relativos al contrato de compraventa definitivo;
                            Como avalúo, honorarios notariales, impuestos de traslado de dominio, derechos de inscripción
                            en el Registro Público de la Propiedad.
                        </li>
                        <li>
                            Acudir a la notaría pública correspondiente para celebrar el contrato de compraventa respectivo.
                        </li>
                    </ol>
                </li>
            </ul>
        ...
        <p>
            <strong>DÉCIMA PRIMERA.- <u>DERECHOS Y OBLIGACIONES DE “LOS PROMITENTES VENDEDORES”.</u> </strong>
            Con motivo del presente contrato
            <strong>“LOS PROMITENTES VENDEDORES”</strong> adquieren los derechos y asumen las obligaciones siguientes:
        </p>
        ...
        <p>
            <ul class="ul-custom">
                <li class="li-custom">
                    ...
                    <ol>
                        <li>
                            Solicitar a <strong>“EL PROMITENTE COMPRADOR”</strong> toda la documentación que sea necesaria para iniciar
                ...
                <li class="li-custom">
                    ...
                    <ol>
                        ...
                        <li>
                            Acudir a la notaría pública correspondiente para suscribir el contrato de compraventa respectivo, una vez que
        ...
        <p>
            <strong>DÉCIMA SEGUNDA.- FONDO DE RESERVA Y MANTENIMIENTO.</strong> Si el Inmueble objeto del presente contrato estuviera sujeto a un régimen
            de propiedad en condominio <strong>“EL PROMITENTE COMPRADOR”</strong> entregará a
            <strong>“LOS PROMITENTES VENDEDORES”</strong> a la firma de esta escritura para constituir el fondo de reserva para el
            mantenimiento y conservación del Conjunto Habitacional
        ...
        <p>
            <strong>DÉCIMA TERCERA.- <u>RESCISIÓN Y PENA CONVENCIONAL.</u></strong> Las partes acuerdan que, en caso de incumplimiento a cualquiera de las obligaciones
            ...
            {{-- Queda entendido de que el incumplimiento de cualquiera de los
        ...
        <p>
            ...
            <strong>
                “LOS PROMITENTES VENDEDORES”
            </strong> ponen a <strong>disposición de “EL PROMITENTE COMPRADOR” el siguiente canal de atención al consumidor,
                para iniciar y
            dar atención y seguimiento a cualquier queja, reclamación o sugerencia:</strong>
        </p>

        <p>
            <ul class="ul-custom">
                <li class="li-custom">
                    Número Telefónico: 444 8334683, 84 al 85, con un horario de atención de las  9:00 horas a las 17:00 horas,
                ...
                <li class="li-custom">
                    <strong>Centro de Ventas (personalizada):</strong> Manuel Gutiérrez Nájera 190. Colonia Tequisquiapam,
        ...
        <p>
            <strong>DÉCIMA SEXTA.- <u>MEDIOS PARA NOTIFICACIONES Y AVISOS.</u></strong> Las notificaciones y avisos que <strong>las partes</strong> contratantes deban darse
            con relación a este Contrato, se harán por escrito recabándose constancia de su recepción y deberán ser enviadas en cualquiera
            de los medios que se señalan a continuación, dándose por totalmente válidas siempre y cuando las partes contratantes no hagan cambio o
        ...
        <p>
            ...
            número 7716-2022 de fecha 1 de diciembre de 2022 Asimismo, el contenido de este contrato se incorporará en escritura pública sin importar el orden
            ...
            @else
                El modelo de contrato de adhesión que se utiliza para documentar la
                presente operación se encuentra aprobado y registrado por la Procuraduría Federal del Consumidor bajo el
                número _________ de fecha _____________ Asimismo, el contenido de este contrato se incorporará en escritura pública sin importar el orden
                y forma en que se citen y esto no se considerará como incumplimiento a la Ley, ni modificación al modelo de contrato registrado ante PROFECO.
                Cualquier variación del contenido del presente contrato en perjuicio de <strong>“EL PROMITENTE COMPRADOR”</strong> se tendrá por no puesta.
            @endif
        </p>
        ...
        <p>
            Este contrato se da y firma en la Ciudad de San Luis Potosí, S.L.P.	a los {{$contrato->fecha_contrato}}.
        </p>

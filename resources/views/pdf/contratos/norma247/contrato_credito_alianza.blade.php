...
<body>
    <div>
        ...
        <p>I.- Declara <strong>CUMBRES</strong>, por conducto de su representante: <br></p>

        <ol>
            <li>
                Que es una sociedad mercantil constituida en escritura pública número 3 de fecha 8 de diciembre de 1999,
                otorgada ante el Notario Público número 33 del primer distrito judicial del estado de San Luis Potosí, Lic. Leopoldo
                de la Garza Marroquín, inscrita en el Registro Público de la Propiedad y del Comercio en San Luis Potosí, San Luis
                Potosí, bajo el folio mercantil 70 que su domicilio fiscal se encuentra en Manuel Gutiérrez Nájera 190. Colonia
                Tequisquiapan, San Luis Potosí, San Luis Potosí y su Registro Federal de Contribuyentes es <strong>GCC000106QS6</strong>
                <br><br>
            </li>
            <li>
        ...
        <ol>
            ...
            <li>
                ...
                <p>
                    Que el inmueble objeto de la compraventa y que se integra por el terreno propiedad de <strong>"CUMBRES"</strong> y
                    lo edificado sobre él, propiedad de <strong>"CONCRETANIA"</strong> cuenta con lo descrito en el “Anexo A” que
                    firmado por “LAS PARTES” es integrante de este instrumento, como aparece en el título de
                    ...
                    el domicilio de <strong>“LOS PROMITENTES VENDEDORES”.</strong>
                </p>
                    ...
                    <ul class="ul-custom">
                        <li>
                            <template class="cuadrado">
                                <img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABQAAAAUCAYAAACNiR0NAAAABmJLR0QA/wD/AP+gvaeTAAAAaklEQVQ4je3Uuw2AMBRD0WuUBRiDzwRImYeWdZgHKRMA65gCOsqHqOLOzZEra+i6RWLig9iUJDEZRtAW5LIE6S7ajvOcI9zQ9yu4bWKr3qlgBStYwX/A5w+d7z+LxBnYk02RANwGx+025QJbXxksupQZ7wAAAABJRU5ErkJggg=="></template>
        ...
        <p><strong>IV.-Declara "EL PROMITENTE COMPRADOR":</strong></p>
        ...
        <p align="center"><strong>CLÁUSULAS</strong></p>
        ...
        <ul class="ul-custom">
            ...
            <li><template class="cuadrado"><img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABQAAAAUCAYAAACNiR0NAAAABmJLR0QA/wD/AP+gvaeTAAAAaklEQVQ4je3Uuw2AMBRD0WuUBRiDzwRImYeWdZgHKRMA65gCOsqHqOLOzZEra+i6RWLig9iUJDEZRtAW5LIE6S7ajvOcI9zQ9yu4bWKr3qlgBStYwX/A5w+d7z+LxBnYk02RANwGx+025QJbXxksupQZ7wAAAABJRU5ErkJggg=="></template>
                ...
                <strong>“EL PROMITENTE COMPRADOR”</strong> se obliga a realizar todas las gestiones y entregar a <br>
                @if($contrato->tipo_credito != 'INFONAVIT-FOVISSSTE' && $contrato->tipo_credito != 'Cofinavit'
                    && $contrato->tipo_credito != 'Infonavit Mas Banco'
                    && $contrato->tipo_credito != 'COFINAVIT I.A' && $contrato->tipo_credito != 'Apoyo Infonavit')
                    {{ mb_strtoupper($contrato->institucion) }}
        ...
        <p>
            <strong>
                CUARTA.- <u>PRECIO EN EL CONTRATO DE COMPRAVENTA DEFINITIVO. “LOS PROMITENTES VENDEDORES”</u>
            </strong>
        ...
        <p>
            ...
            modificaciones para lo cual utilizarán el formato que se indica en el “Anexo E” indicando asimismo el plazo para la
        ...
        <p>
            <strong>
                SEXTA.- <u>ENTREGA FÍSICA Y MATERIAL DEL INMUEBLE.</u> “LOS PROMITENTES VENDEDORES”
            </strong>
        ...
        <p>
            ...
            ubicado en Manuel Gutiérrez Nájera #190 Col. Tequisquiapan de la Ciudad de San Luis Potosí, S.L.P.
        ...
        <p>
            ...
            Contando <strong> “LOS PROMITENTES VENDEDORES”</strong> con _______________________________, como mecanismo coadyuvante para hacer frente a la garantía del inmueble.
        </p>
        ...
        <p>
            ...
            </strong> a terceros, con fines mercadotécnicos o publicitarios, la información proporcionada por él con motivo del presente Contrato
            y si (  ) no (  ) acepta que <strong> “LOS PROMITENTES VENDEDORES”</strong> le envíen publicidad sobre bienes y servicios.
        </p>
        ...
        <p>
            ...
            “LOS PROMITENTES VENDEDORES”.</u> </strong> Con motivo del presente contrato
        ...
        <p>
            ...
            <strong>
                “LOS PROMITENTES VENDEDORES”
            </strong> pone a disposición de <strong>“EL PROMITENTE COMPRADOR” el siguiente canal de atención al consumidor, para iniciar y
        ...
        <p>
            <ul class="ul-custom">
                ...
                <li class="li-custom">
                    <strong>Centro de Ventas (personalizada):</strong> Manuel Gutiérrez Nájera 190. Colonia Tequisquiapan, con un horario de atención de las
        ...
        <p>
            ...
            las partes contratantes deban darse con relación a este Contrato, se harán por escrito
        ...
        <p><strong>“EL PROMITENTE COMPRADOR”:
            <div style="margin-left: 30px;">
                Nombre: <u>{{ mb_strtoupper($contrato->c_nombre) }} {{ mb_strtoupper($contrato->c_apellidos) }}</u></strong><br>

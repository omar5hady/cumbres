...
<body>
    <div>
        ...
        @if($contrato->emp_constructora == 'CONCRETANIA')
            <p><strong>I.- Declaran “EL PROMITENTE VENDEDOR”:</strong></p>
        @endif

        <p><strong>I.- Declara "EL PROMITENTE VENDEDOR":</strong> por conducto de su representante:</p>
        ...
        <ol>
            ...
            @else
                <li>
                    Que es una sociedad mercantil constituida en escritura pública número 764 volumen 21 de fecha
                    25 de julio de 2018, otorgada ante el Notario Público número 4 del estado de San Luis Potosí,
                    Lic. Octaviano Gómez y González, inscrita en el Registro Público de la Propiedad y del Comercio en
                    San Luis Potosí, San Luis Potosí, bajo el folio mercantil electrónico N°. 2018073682 que su
                    domicilio fiscal se encuentra en Manuel Gutiérrez Nájera 180. Colonia Tequisquiapan, San Luis Potosí,
                    San Luis Potosí y su Registro Federal de Contribuyentes es <strong>CON180725REA.</strong>
                </li>
                <li>
            ...
            <li>
                ...
                las que se celebrará el contrato de compraventa por el que
                <strong>
        ...
        <p>
            II.- Declara <strong>"EL PROMITENTE COMPRADOR":</strong></p>
        ...
        <p>
            ...
            <strong>“EL PROMITENTE VENDEDOR” </strong> notificarán a <strong> “EL PROMITENTE COMPRADOR”,</strong>
            con al menos 1 día hábil de anticipación, la fecha en que
        ...
        <p>
            <ul class="ul-custom">
                <li class="li-custom">
                    El objeto de la compraventa será el inmueble destinado a casa habitación descrito en el “Anexo A”.
                </li>
                <li class="li-custom">
        ...
        <p>
            ...
            <strong>“EL PROMITENTE VENDEDOR” </strong> le envie publicidad sobre bienes y servicios.
        </p>
            ...
            <ul class="ul-custom">
                <li class="li-custom">
                    ...
                    <ol>
                        ...
                        @else
                            <li>
                                Recibir la información detallada y puntual por parte de <strong>"EL PROMITENTE VENDEDOR"</strong> respecto
                                del inmueble que será objeto del contrato de compraventa.
                            </li>
                            <li>
                                Una vez aprobado su crédito, celebrar el contrato de compraventa en escritura pública.
                            </li>
        ...
        <p>
            <strong>DÉCIMA PRIMERA.- <u>DERECHOS Y OBLIGACIONES DE
                “EL PROMITENTE VENDEDOR”.</u> </strong> Con motivo del presente contrato
            <strong>
        ...
        <p>
            ...
            estuviera sujeto a un régimen de propiedad en condominio <strong>“EL PROMITENTE COMPRADOR”</strong> entregará a
            <strong>
                “EL PROMITENTE VENDEDOR”
        ...
        <p>
            <strong>
                Número Telefónico: 444 8334683, 84 al 85 con un horario de atención de las 9:00 horas a las
                17:00 horas, los dias lunes a viernes y sabado de 9
            </strong>
        </p>
        @endif
        ...
        <p>
            <ul class="ul-custom">
                ...
                @else
                    <li class="li-custom">:00 horas a 13 horas.
                    </li>
                @endif
                <li class="li-custom">
        ...
        <p>
            ...
            @else --}}
                ...
                número <strong>{{ $contrato->emp_constructora == 'CONCRETANIA' ? '8021-2023' : '4444-2023' }}</strong>
                de fecha <strong>{{ $contrato->emp_constructora == 'CONCRETANIA' ? '04 de septiembre del 2023.' : '02 DE MAYO DE 2023.' }}</strong>

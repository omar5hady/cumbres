...
<body>
    <div>
        ...
        <ol>
            <li>
                Es una persona física de nacionalidad {{($contrato->nacionalidad) == 0 ? 'Mexicana': 'Extranjera'}}
            ...
            <li>
                Que contando con la información suficiente a que se refiere el articulo 73 bis de la Ley Federal de Protección al Consumidor,
            ...
            <li>
                Conoce el TERRENO y manifiesta que la información y documentación relativa a la misma que se le proporcionó,
        ...
        <p>
            ...
            <strong>Anexo “A”</strong> del presente contrato, el cual firmado por ambas partes forma parte integrante del mismo.
        </p>
        ...
        <p>
            ...
            del plazo establecido, <strong>“EL VENDEDOR”</strong> deberá pagar a <strong>“EL COMPRADOR”</strong>
            un interés equivalente al ___ % ( _____ por ciento)
        ...
        <ol>
            ...
            <li>
                Llevar a cabo el pago total de la operación convenida en los términos establecidos en la Cláusula Segunda del
                presente Contrato.
            </li>
            <li>
            ...
            <li>
                ...
                objeto de este contrato, para lo cual (i) se abstendrá de construir o edificar obra alguna distinta de la que
                autorice la licencia de construcción otorgada para dicho Conjunto Habitacional, respetando el uso del terreno
                así como (ii) respetar y conservar el diseño y plan maestro del Conjunto Habitacional
            </li>
            <li>
        ...
        <p>
            <strong>NOVENA DESTINO Y MODIFICACIÓN DEL TERRENO.</strong> A fin de preservar el entorno urbanístico y arquitectónico del
        ...
        <ul class="ul-custom">
            <li class="li-custom">Restricciones Ambientales______________________.</li>
            <li class="li-custom">Colindancias con zonas ecológicas, reservas forestales y reservas federales ______________________.</li>
            <li class="li-custom">Cualquier otra limitación decretada por autoridades competentes y/o previstas en la legislación aplicable_____________________.</li>
        </ul>
        ...
        <p>
            ...
            respectivo, debiendo devolver el remanente a este último, dentro de los días ______ hábiles siguientes a la rescisión del presente contrato.
        </p>
        ...
        <p>
            Sin perjuicio de lo anterior, <strong>“LAS PARTES”</strong> se someten a la jurisdicción de los tribunales competentes de la Ciudad de San Luis Potosí,
    ...
    <div>
        ...
        <p class="small">
            Se le hace del conocimiento a <strong>“EL COMPRADOR”:</strong> que contamos con canales de atención de quejas y solicitudes gratuitos y accesibles,
            ...
            Y el plazo de respuesta de <strong>“EL VENDEDOR”</strong> es de: 8 días hábiles
        </p>

        <p class="small">
            <strong>
                <u>IMPORTANTE PARA “EL COMPRADOR”: </u>Antes de que firme como constancia de que tuvo a su disposición la información y documentación

...
.table-row { display: table-row; }
    ...
    <body>
        ...
        <div>
            ...
            <p>
                g)  Que es su deseo celebrar el presente contrato preparatorio con <strong>EL PROMITENTE COMPRADOR</strong> a efecto de obligarse a celebrar el
            ...
            <p>
                ...
                está sujeto a la condición suspensiva consistente en que <strong>{{mb_strtoupper($contratoPromesa[0]->institucion)}}
                    @if($contratoPromesa[0]->infonavit > 0) e INFONAVIT @elseif($contratoPromesa[0]->fovisste > 0) y FOVISSTE @endif </strong>,
                otorgue al <strong>PROMITENTE COMPRADOR</strong>  un crédito con garantía hipotecaria hasta por la cantidad
            ...
            <p>
                ...
                Por lo que <strong>EL PROMITENTE COMPRADOR</strong> no se reserva ningún derecho de ejercitar posteriormente sobre este particular,

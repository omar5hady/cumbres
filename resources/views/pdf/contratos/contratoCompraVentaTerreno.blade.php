...
<br>
 ...
 <br>
    <div class="container">
        <center><h4><strong style="color:#0B173B">IMPORTANTE: En todos los depósitos  o transferencias favor de anotar la referencia:
 ...
 <ul  style="font-size:12pt;">
  ...
  <li align="justify">EN CASO DE REALIZAR TU PAGO ELECTRONICO EN UNA SUCURSAL BANCARIA ENTREGA TU COMPROBANTE EN NUESTRAS OFICINAS
      CENTRALES O VIA CORREO ELECTRONICO (escaneado o foto digital del comprobante), AL EMAIL: <u>cobranza@concretania.mx</u> <br><br>

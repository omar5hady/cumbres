                ...
                <table style="margin-left: -0.15in;">
                    ...
                    <tr>
                        <td width=220 colspan="5"><center>GRUPO CONSTRUCTOR CUMBRES, S.A. de C.V.
                            <br> REPRESENTADA POR EL 
                            <br> ING. ALEJANDRO F. PEREZ ESPINOSA</center></td>
                        <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td width=220 colspan="5"><center>CONCRETANIA, S.A. de C.V.
                            <br> REPRESENTADA POR EL 
                            <br> ING. DAVID CALVILLO MARTÍNEZ</center></td>
                    </tr>
                </table>
            @else
                <center>
                        ...
                        <tr>
                            <td width=460 colspan="5">
                                <center>
                                    ...
                                    @if($contrato->emp_constructora == 'CONCRETANIA')
                                        <br> REPRESENTADA POR EL 
                                        <br> ING. DAVID CALVILLO MARTÍNEZ
                                    @else
                                        <br> REPRESENTADA POR EL 
                                        <br> ING. ALEJANDRO F. PEREZ ESPINOSA
                                    @endif
                                </center>
                            </td>
                        </tr>

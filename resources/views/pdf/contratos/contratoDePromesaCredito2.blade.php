...
<p>
    ...
    LA DIVERSA SOCIEDAD DENOMINADA <strong>CONCRETANIA, S. A. DE. C.V</strong>,  REPRESENTADA EN ESTE ACTO POR EL ING. DAVID CALVILLO MARTINEZ,
     A QUIEN EN LO SUCESIVO Y PARA LOS EFECTOS DEL PRESENTE CONTRATO, SE LE DENOMINARA COMO <strong>CONCRETANIA </strong>Y 
     A AMBAS PERSONAS MORALES CUANDO SE LES DESIGNE CONJUNTAMENTE SERÁ COMO <strong>LOS PROMITENTES VENDEDORES</strong>, 
...
@if($contratoPromesa[0]->regimen_condom == 1)
    <p>
        c) Que le fue explicado que <strong>EL LOTE</strong> y <strong>LA VIVIENDA</strong> se encuentran dentro de un régimen de propiedad en condominio y que dicha vivienda quedará sujeta a las disposiciones 
        establecidas en el Régimen de Condominio y el reglamento de condóminos correspondiente.
    </p>

    <p>
    d) Que cuenta con los recursos económicos suficientes para adquirir la propiedad de <strong>EL LOTE</strong> y <strong>LA VIVIENDA</strong>, una vez que haya sido designada 
    ...
    <p>
    e) Que es su deseo celebrar el presente contrato con <strong>LOS PROMITENTES VENDEDORES</strong> con el objeto de obligarse a 
...
@else
    ...
    <p>
    c) Que cuenta con los recursos económicos suficientes para adquirir la propiedad de <strong>EL LOTE</strong> y <strong>LA VIVIENDA</strong>, una vez que haya sido designada 
    beneficiaria de un crédito hipotecario otorgado por <strong>{{mb_strtoupper($contratoPromesa[0]->institucion)}} 
        @if($contratoPromesa[0]->infonavit > 0) e INFONAVIT @elseif($contratoPromesa[0]->fovisste > 0) y FOVISSTE @endif </strong>, 
    mismo que en lo sucesivo y para los efectos del presente contrato será denominado como <strong>Hipotecario</strong>.  
    Para tal efecto, manifiesta bajo protesta de decir verdad, que cuenta con historial crediticio 
...
<p>
    <strong>PRIMERA.-</strong> Sujeto a la condición que se establece en la cláusula segunda del presente contrato, <strong>CUMBRES</strong> se obliga a celebrar con el carácter 
    de vendedora, un contrato de compraventa respecto de <strong>EL LOTE</strong> descrito en la declaración I, inciso c), en tanto que <strong>CONCRETANIA</strong> se obliga a celebrar con el 
    mismo carácter el contrato definitivo de compraventa respecto a  <strong>LA VIVIENDA</strong>  que se construirá sobre el mismo lote, con <strong>EL PROMITENTE COMPRADOR</strong>, y a su 
    vez, <strong>EL PROMITENTE COMPRADOR</strong>, se obliga a celebrar, con el carácter de comprador, el contrato de compraventa a que esta cláusula se refiere, en el entendido 
    de que ambas ventas podrán plasmarse en el mismo contrato por formar <strong>LA VIVIENDA</strong> una accesión de <strong>EL LOTE</strong>.
</p>

<br>
<p>
    <strong>SEGUNDA.- </strong> <strong>EL PROMITENTE COMPRADOR</strong> señala estar de acuerdo con: A). Las características de la urbanización del terreno. 
B). La superficie de construcción que es de <strong>{{$contratoPromesa[0]->construccion}}m2.</strong> C). La fecha de entrega de <strong>LA VIVIENDA</strong> a <strong>EL PROMITENTE COMPRADOR</strong>, 
    se realizara quince días hábiles posteriores a la firma de escrituras. Por lo que <strong>EL PROMINENTE COMPRADOR</strong> no sé reserva 
...
<br>
<p>
    <strong>TERCERA.- </strong>El precio total que  será motivo de la operación de compraventa definitiva, es la suma 
...
<p>
    Cada una de esas parcialidades, incluyendo la que se efectúe con el crédito otorgado , deberá entregarse a <strong>CONCRETANIA</strong>, 
...
<p>
    ...
    de la construcción de <strong>LA VIVIENDA</strong>. En razón de lo anterior, las partes están de acuerdo para que en 
    ...
    promesa de compraventa, deslindando desde este momento <strong>EL PROMITENTE COMPRADOR</strong> a <strong>LOS PROMITENTES VENDEDORES</strong> 
...
<p>
    ...
    naturales contados a partir de la terminación de la construcción de <strong>LA VIVIENDA</strong>,  o que el monto 
    otorgado en crédito por la institución bancaria fuera menor a la cantidad establecida en la cláusula 
    tercera inciso a), con lo que se incumple la condición suspensiva, <strong>LOS PROMITENTES VENDEDORES</strong>, 
    reembolsarán a <strong>EL PROMITENTE COMPRADOR</strong>, en la proporción que les corresponda y en un término de 
    90 días naturales contados a partir de la fecha de la terminación de la casa habitación, la o 
    las cantidades que hasta esa fecha le haya(n) sido pagada(s) por <strong>EL PROMITENTE COMPRADOR</strong>, menos 
    ...
    contrato; sin que exista obligación alguna por parte de <strong>LOS PROMITENTES VENDEDORES</strong> de cubrir ninguna 
    ...
    están de acuerdo en que <strong>LOS PROMITENTES VENDEDORES</strong> podrán enajenar <strong>EL LOTE</strong> y  <strong>LA VIVIENDA</strong> a favor de 
...
<p>
    <strong>LOS PROMITENTES VENDEDORES</strong> podrá ofrecer asesoría e incluso, coadyuvar con <strong>EL PROMITENTE COMPRADOR</strong> 
...
<br>
<p>
    <strong>NOVENA.-</strong> Todas las comunicaciones que las partes deban o deseen hacerse en relación con este 
...
<br>
<p>
    <strong>DECIMA.-</strong> Para todo lo relacionado con la interpretación, cumplimiento y ejecución del presente Contrato, las partes se someten a la jurisdicción y 
